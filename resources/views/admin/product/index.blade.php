    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-actions">
                <a class="btn btn-sm btn-primary" href="{{ admin_url('woocommerce/products/create') }}">
                    <small>
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ admin_url('woocommerce/products/destroy-multi') }}">
                @csrf
                @method('DELETE')
                <table class="table table-responsive-sm table-bordered table-hover font12">
                    ...
                    <tr class="bg-light">
                        ...
                        <th>{{ trans('lang_woocommerce::product.sku') }}</th>
                        <th>
                            <a href="">
                                {{ trans('lang_woocommerce::product.title') }}
                            </a>
                        </th>
                    ...
                    @if ($items->count() > 0)
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ admin_url('woocommerce/products/'.$item->id.'/edit') }}">
                                        {{ $item->title }}
