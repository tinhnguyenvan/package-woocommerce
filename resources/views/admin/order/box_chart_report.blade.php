    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div style="font-size: 17px" id="totalRevenue">0 {{ config('app.currency') }}</div>
                        <div>
                            <i class="icon fa fa-money"></i> {{ trans('lang_woocommerce::sale_order.report.total_revenue') }}
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div style="font-size: 17px" id="totalRevenue7day">0 {{ config('app.currency') }}</div>
                        <div>
                            <i class="icon fa fa-money"></i> {{ trans('lang_woocommerce::sale_order.report.total_revenue_7day') }}
                        </div>
                        <div class="progress progress-xs my-2">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div style="font-size: 17px" id="totalOrderCompleted">0</div>
                        <div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div style="font-size: 17px" id="totalOrderNew">0</div>
                        <div>
                    ...
                    Highcharts.chart('chart-data', {
                        ...
                        yAxis: [
                            ...
                            },
                            {
                                ...
                                labels: {
                                    format: '{value} {{ config('app.currency') }}',
                                    style: {
                                        color: Highcharts.getOptions().colors[0]
                                    }
                                },
                        ...
                        series: [{
                            ...
                            data: result.total,
                            tooltip: {
                                valueSuffix: ' {{ config('app.currency') }}'
                            }
                        }, {
                            name: title_order,
                            type: 'spline',
